...
## inform the user of file creation
print("tidydata.txt created in current working directory", quote=F)

## inform the user of how to read in new data set
print("Use the following command to read in the new tidy data:", quote=F)
print("read.table(\"tidydata.txt\", sep=\"\t\", header=T)", quote=F)
